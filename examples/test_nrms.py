...
def dist_eval(args):
    ...
    with open(os.path.join(data_path, 'nrms-valid-prediction.{}.txt'.format(args.split)), 'w') as f:
...
def test(args):
    ...
    with open(os.path.join(data_path, 'nrms-test-prediction.{}.txt'.format(args.split)), 'w') as f:
